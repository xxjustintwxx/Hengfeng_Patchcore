...
#SBATCH --job-name=ct11_image_yolo
...
echo "=== YOLOv11-seg CT11_Image Training ==="
echo "Classes : Main IC(2), board(1), component(10), connector(1), resistor(40), screw(1)"
echo "Node    : $(hostname)"
echo "GPU     : $(nvidia-smi --query-gpu=name --format=csv,noheader 2>/dev/null || echo 'N/A')"
echo "Python  : $(which python)"
echo ""

python yolo/CT11_Image/train_ct11_image_seg.py
