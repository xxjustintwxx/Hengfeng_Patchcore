...
#SBATCH --job-name=ct11_image_infer
...
echo "=== CT11_Image Inspection: test/defect ==="
python yolo/CT11_Image/infer_ct11_image.py \
  --image_dir data/CT11_Image/ir_module_1024/ir_module/test/defect \
  --save

echo ""
echo "=== CT11_Image Inspection: test/good ==="
python yolo/CT11_Image/infer_ct11_image.py \
  --image_dir data/CT11_Image/ir_module_1024/ir_module/test/good \
  --save

echo ""
echo "=== Done. Heatmaps at results/heatmaps/CT11_Image/ ==="
